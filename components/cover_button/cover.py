    ...
    .extend(
        {
            ...
            cv.Optional(
                CONF_ACTUATOR_ACTIVATION_DURATION, default="0s"
...
async def to_code(config):
    # Make the button-controller declarations available to user lambdas.
    cg.add_global(cg.RawStatement('#include "cover_button.h"'))
